...
var backgroundCurtain = document.querySelectorAll(".banner-background .background-curtain.animation");
var informations = document.querySelectorAll(".project-banner .information");
var bannerProjectImage = document.querySelector(".project-banner .project-image");
...
var swiperButtonAlternate = document.querySelectorAll(".alternate .swiper-button");
...
var projectDetailsContainer = document.querySelector(".section-project-details");
var contactTitle = document.querySelectorAll(".section-contact .contact-title");
var contactInformations = document.querySelectorAll(".section-contact .contact-informations");
var contactForm = document.querySelector(".section-contact .contact-form");
var projectMediaGridBlock3inC = document.querySelectorAll(".swiper.project-media-grid-block.type-3inC");
var projectMediaGridBlock2inC = document.querySelectorAll(".swiper.project-media-grid-block.type-2inC");
...
// GSAP Footer Background Scroll Trigger
...
// Equal height function for Front & Back Layer Sections
...
function loadBrandLogoWhite() {
  brandLogoWhite.forEach(function (brandLogo) {
    ...
    var brandWhite = bodymovin.loadAnimation({
      container: brandLogo,
      path: homeUrlInput.value + '/wp-content/themes/reino/assets/json/logo-white.json',
      renderer: 'canvas',
      loop: false,
      autoplay: true,
...
function loadBrandLogoBlack() {
  brandLogoBlack.forEach(function (brandLogo) {
    ...
    var brandBlack = bodymovin.loadAnimation({
      container: brandLogo,
      path: homeUrlInput.value + '/wp-content/themes/reino/assets/json/logo.json',
      renderer: 'canvas',
      loop: false,
      autoplay: true,
      name: "Brand Animation",
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (navigationMenus) {
    navigationMenus.forEach((navigationMenu) => {
      var menuItems = navigationMenu.querySelectorAll("li .menu-item span");
      gsap.to(menuItems, {
        duration: 0.5,
        y: "0%",
        ease: "power4.out",
    ...
    btnMenuTrigger.forEach((btnMenu) => {
      btnMenu.addEventListener("click", function () {
        if (menuOpen === 0) {
          ...
          var menuItems = menuContainer[0].querySelectorAll("li .menu-item span");
  ...
  // GSAP Timeline for Banner Curtain
  ...
  // GSAP Timeline for Banner Title
  if (bannerTitle) {
  ...
  // GSAP Timeline for Banner Highlight
  if (bannerHighlight) {
  ...
  // GSAP Timeline for Banner Informations
  ...
  // GSAP Timeline for Banner Image
  ...
  // GSAP Timeline for Banner Sliders
  if (projectsPrimary && projectsSecondary1 && projectsSecondary2 && swiperControl && projectsTitleOne && projectsTitleTwo && webInformationAction && webInformationOption && layerBack) {
    if (projectsPrimary) {
    ...
    timeline.add([projectsPrimarySlider, projectsSecondary1Slider, projectsSecondary2Slider]).add(swiperControls).add(projectsTitleOne);
  }
  ...
  if (scrollToSection && scrollDownButton) {
    scrollDownButton.addEventListener("click", function () {
      ...
      gsap.to(window, { duration: 0.6, scrollTo: { y: scrollToSection, offsetY: 50 } });
    })
  }

  // GSAP About Scroll Trigger
  if (aboutContainers && windowWidth > 480) {
    aboutContainers.forEach((aboutContainer) => {
      var aboutTitle = aboutContainer.querySelector(".about-title .title");
      var aboutDescription = aboutContainer.querySelectorAll(".about-description");
      gsap.registerPlugin(ScrollTrigger);
  ...
  works.forEach((works) => {
    if (works) {
      ...
      workitem.forEach((element) => {
        ...
        var workMediaImage = element.querySelector(".work-item-media .image");
        var workMediaVideo = element.querySelector(".work-item-media .video");
        var workDescription = element.querySelector(".work-item-description");
        if (workSerial) {
  ...
  // GSAP Project Details Scroll Trigger
  if (projectDetailsContainer && windowWidth > 480) {
    ...
    // Project Details Media Block
    var projectMediaBlock = projectDetailsContainer.querySelectorAll(".project-media-block");
    ...
    var projectTextBlock = projectDetailsContainer.querySelectorAll(".project-text-block");
    if (projectTextBlock) {
      projectTextBlock.forEach((item, index) => {
        var textBlockContent = item.querySelector(".text-block-content");
    ...
    // Project Details Media Grid Block
    var projectMediaGridBlock = projectDetailsContainer.querySelectorAll(".project-media-grid-block");
    if (projectMediaGridBlock) {
      projectMediaGridBlock.forEach((item, index) => {
        var mediaGridItem = item.querySelectorAll(".media-grid-item > div");
  ...
  projectsPrimarySwiper.controller.control = [projectTitleOneSwiper, projectTitleTwoSwiper, projectsSecondaryOneSwiper, projectsSecondaryTwoSwiper];
  ...
  // Media Grid 3inC Swiper instance
  ...
  // Media Grid 2inC Swiper instance
  ...
  // Equal height for Front & Back Layer Sections
  ...
  logDivHeight(".layer-front .section-services", ".layer-back .section-services");
  logDivHeight(".layer-front .section-clients", ".layer-back .section-clients");
  logDivHeight(".layer-front footer", ".layer-back footer");
  logDivHeight(".layer-front .section-project-details", ".layer-back .section-project-details");
  logDivHeight(".layer-front .section-contact", ".layer-back .section-contact");
  logDivHeight(".layer-front .section-works", ".layer-back .section-works");
  logDivHeight(".layer-front .section-services-banner", ".layer-back .section-services-banner");
  logDivHeight(".layer-front .section-services-teams", ".layer-back .section-services-teams");
  logDivHeight(".layer-front .section-services-collaborate", ".layer-back .section-services-collaborate");
  logDivHeight(".layer-front .section-services-why-us", ".layer-back .section-services-why-us");
  logDivHeight(".layer-front .section-services-works", ".layer-back .section-services-works");
});

// Equal height function triggers when load for Front & Back Layer Sections
...
// Equal height function triggers when resize for Front & Back Layer Sections
...
// Equal height function triggers when scroll for Front & Back Layer Sections
